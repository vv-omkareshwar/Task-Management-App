...
const Signup: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const checkAuthAndWarmup = async () => {
            ...
            try {
                await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/`, { signal });
            } catch (error) {
    ...
    const togglePasswordVisibility = (e: React.MouseEvent<HTMLImageElement>): void => {
        e.preventDefault();
